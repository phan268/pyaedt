...
solution_data = ipk.post.get_solution_data(expressions="Temperature",primary_sweep_variable="Distance",context=line.name, report_category="Fields")
solution_data.enable_pandas_output=True

solution_data.plot()

display(solution_data.data_real())
